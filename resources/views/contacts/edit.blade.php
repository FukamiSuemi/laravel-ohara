      ...
      <div class="-m-2">
        ...
        <div class="p-2 w-full">
          <div class="relative">
            ...
            <input type="radio" id="gender" name="gender" @if($gender === '男性') checked @endif value="0" class="mr-2">男性
            <input type="radio" id="gender" name="gender" @if($gender === '女性') checked @endif value="1" class="mr-2">女性
          </div>
        </div>
        <div class="p-2 w-full">
          <div class="relative">
