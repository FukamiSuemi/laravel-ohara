      ...
      <div class="-m-2">
        ...
        <div class="p-2 w-full">
          <div class="relative">
            ...
            <input type="radio" id="gender" name="gender" value="0" {{old('gender') === 0 ? 'checked':''}} class="mr-2">男性
            <input type="radio" id="gender" name="gender" value="1" {{old('gender') === 1 ? 'checked':''}} class="mr-2">女性
          </div>
        </div>
        <div class="p-2 w-full">
          <div class="relative">
