  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="-m-2">
        ...
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="url" class="leading-7 text-sm text-gray-600">件名</label>
        ...
        <div class="p-2 w-full">
          <div class="relative">
            ...
            <textarea id="text" name="contact" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
          </div>
        </div>
        <div class="p-2 w-full">
